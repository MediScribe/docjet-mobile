...
// in docjet_mobile/test/core/auth/presentation/corrupted_cache_test.dart.
...
///
/// See the documentation for Mockito's code generation for more information.
class MockIUserProfileCache extends _i1.Mock implements _i9.IUserProfileCache {
  ...
  _i4.Future<void> saveProfile(
    _i10.UserProfileDto? profileDto,
    DateTime? timestamp,
  ) =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i4.Future<_i10.UserProfileDto?> getProfile(String? userId) =>
      (super.noSuchMethod(
        Invocation.method(
          #getProfile,
          [userId],
        ),
        returnValue: _i4.Future<_i10.UserProfileDto?>.value(),
      ) as _i4.Future<_i10.UserProfileDto?>);

  @override
  _i4.Future<void> clearProfile(String? userId) => (super.noSuchMethod(
        Invocation.method(
          #clearProfile,
          [userId],
        ),
  ...
  @override
  _i4.Future<void> clearAllProfiles() => (super.noSuchMethod(
        Invocation.method(
          #clearAllProfiles,
          [],
        ),
  ...
  @override
  _i4.Future<bool> isProfileStale(
    String? userId, {
